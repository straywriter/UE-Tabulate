...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulatemario, "Tabulate.mario", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulatemario::RunTest(const FString& Parameters){
  Table mario;
