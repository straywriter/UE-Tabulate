...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulateemployees, "Tabulate.employees", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulateemployees::RunTest(const FString& Parameters){
  Table employees;
