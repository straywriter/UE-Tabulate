...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulatepadding, "Tabulate.padding", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulatepadding::RunTest(const FString& Parameters){
  Table no_padding;
