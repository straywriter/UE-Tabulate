...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulaterunic, "Tabulate.runic", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulaterunic::RunTest(const FString& Parameters){
