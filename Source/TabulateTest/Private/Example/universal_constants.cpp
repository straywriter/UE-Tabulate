...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulateuniversal_constants, "Tabulate.universal_constants", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulateuniversal_constants::RunTest(const FString& Parameters){
