...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulaterefresh_table, "Tabulate.refresh_table", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
bool FTabulaterefresh_table::RunTest(const FString& Parameters){
