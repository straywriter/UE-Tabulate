...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulateclass_diagram, "Tabulate.class_diagram", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulateclass_diagram::RunTest(const FString& Parameters){
