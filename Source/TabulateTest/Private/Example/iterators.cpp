...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulateiterators, "Tabulate.iterators", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulateiterators::RunTest(const FString& Parameters){
  Table table;
