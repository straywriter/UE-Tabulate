...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulatemovies, "Tabulate.movies", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulatemovies::RunTest(const FString& Parameters){
  Table movies;
