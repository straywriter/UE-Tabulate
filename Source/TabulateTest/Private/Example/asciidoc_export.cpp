...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulateasciidoc_export, "Tabulate.asciidoc_export", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulateasciidoc_export::RunTest(const FString& Parameters){
  Table movies;
