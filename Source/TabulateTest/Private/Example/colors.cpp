...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulatecolors, "Tabulate.colors", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulatecolors::RunTest(const FString& Parameters){
  Table colors;
