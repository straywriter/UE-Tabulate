...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTabulatesummary, "Tabulate.summary", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FTabulatesummary::RunTest(const FString& Parameters){
